...
# Abundance Over Time: Single & Multiple Species Models
# cvaage@uw.edu
...
write.csv(clean_ss_s, file = paste0(output_folder, "/rc_abundance_ss_s_reps.csv"), row.names = FALSE)
write.csv(clean_ss_r, file = paste0(output_folder, "/rc_abundance_ss_r_reps.csv"), row.names = FALSE)
...
# Export data file to output
write.csv(clean_ms_s, file = paste0(output_folder, "/rc_abundance_ms_s_reps.csv"), row.names = FALSE)
write.csv(clean_ms_r, file = paste0(output_folder, "/rc_abundance_ms_r_reps.csv"), row.names = FALSE)
